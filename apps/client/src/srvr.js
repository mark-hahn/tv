...
export function ignoreGaps(showName, episodes) {
  return httpCall("/api/ignoreGaps", { showName, episodes }, "POST");
}
...
export function dupeFolderMerge(showName) {
  return httpCall("/api/dupeFolderMerge", { showName }, "POST");
}
