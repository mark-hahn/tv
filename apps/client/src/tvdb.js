...
// Computed/default props applied to every tvdb show record. Lives in
// @tv/share because tv-srvr has to derive the very same props before it can
// filter and sort the list the way this client does.
// Must be re-applied after merging a fresh server record (mergeTvdbRecord
// does this automatically).
import { applyComputedProps } from "@tv/share";
export { applyComputedProps };
